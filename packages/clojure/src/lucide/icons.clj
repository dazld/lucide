...
(defn
 ...
 ([{:keys [width height]}]
  [:svg
   ...
   [:circle {:fill "currentColor", :r ".5", :cy "12.5", :cx "11.5"}]]))
(defn
 ham
 ([] (ham {}))
 ([{:keys [width height]}]
 ...
 ([{:keys [width height]}]
  [:svg
   {"xmlns" "http://www.w3.org/2000/svg",
    ...
    :strokeLinecap "round",
    :height (or height "24")}
   [:line {:y2 "22", :y1 "22", :x2 "21", :x1 "3"}]
   [:line {:y2 "11", :y1 "18", :x2 "6", :x1 "6"}]
   [:line {:y2 "11", :y1 "18", :x2 "10", :x1 "10"}]
   [:line {:y2 "11", :y1 "18", :x2 "14", :x1 "14"}]
   [:line {:y2 "11", :y1 "18", :x2 "18", :x1 "18"}]
...
(defn
 ...
 ([{:keys [width height]}]
  [:svg
   ...
   [:line {:y2 "10", :y1 "3", :x2 "14", :x1 "21"}]
   [:line {:y2 "14", :y1 "21", :x2 "10", :x1 "3"}]]))
(defn
 maximize
 ([] (maximize {}))
 ([{:keys [width height]}]
...
(defn
 ...
 ([{:keys [width height]}]
  [:svg
   ...
   [:path
    {:d
     "M5.6 5.6C3 8.3 2.2 12.5 4 16l-2 6 6-2c3.4 1.8 7.6 1.1 10.3-1.7"}]]))
(defn
 message-circle-plus
 ([] (message-circle-plus {}))
 ([{:keys [width height]}]
...
(defn
 ...
 ([{:keys [width height]}]
  [:svg
   ...
   [:path
    {:d
     "M17 8v.8A6 6 0 0 1 13.8 20H10A6.5 6.5 0 0 1 7 8a5 5 0 0 1 10 0Z"}]
   [:path {:d "m14 14-2 2"}]]))
(defn
 shuffle
 ([] (shuffle {}))
...
(defn
 ...
 ([{:keys [width height]}]
  [:svg
   ...
   [:path {:d "M3 14v1"}]
   [:path {:d "M21 14v1"}]
   [:line {:y2 "8", :y1 "8", :x2 "15", :x1 "7"}]
   [:line {:y2 "12", :y1 "12", :x2 "17", :x1 "7"}]
   [:line {:y2 "16", :y1 "16", :x2 "13", :x1 "7"}]]))
(defn
 text
 ([] (text {}))
 ([{:keys [width height]}]
 ...
 ([{:keys [width height]}]
  [:svg
   {"xmlns" "http://www.w3.org/2000/svg",
    ...
    :strokeLinecap "round",
    :height (or height "24")}
   [:line {:y2 "6", :y1 "6", :x2 "21", :x1 "3"}]
   [:path {:d "M3 12h15a3 3 0 1 1 0 6h-4"}]
   [:polyline {:points "16 16 14 18 16 20"}]
   [:line {:y2 "18", :y1 "18", :x2 "10", :x1 "3"}]]))
(defn
 wrench
 ([] (wrench {}))
 ([{:keys [width height]}]
